...
if ( ! class_exists( 'TwentyTwenty_Customize' ) ) {
	...
	class TwentyTwenty_Customize {
		...
		public static function register( $wp_customize ) {
			 ...
			 */
			$wp_customize->add_section(
				'allianz_frontpage_design',
				array(
					'title'       => __( 'Allianz Design', 'twentytwenty' ),
					'capability'  => 'edit_theme_options',
					'description' => __( 'Settings for the "Allianz Front page" ', 'twentytwenty' ),
					'priority'    => 43,
				)
			);
			...
			$wp_customize->add_control(
				'allianz_left_column',
				array(
					'label'       => __( 'Left column on frontpage', 'twentytwenty' ),
					'description' => __( 'Define which page should be used for the left frontpage column', 'twentytwenty' ),
					'section'     => 'allianz_frontpage_design',
					'type'        => 'dropdown-pages'
				)
			);

			$wp_customize->add_setting(
				'allianz_right_column'
			);

			$wp_customize->add_control(
				'allianz_right_column',
				array(
					'label'       => __( 'Right column on frontpage', 'twentytwenty' ),
					'description' => __( 'Define which page should be used for the right frontpage column', 'twentytwenty' ),
					'section'     => 'allianz_frontpage_design',
					'type'        => 'dropdown-pages'
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Media_Control(
					$wp_customize,
					'allianz_hero_image', #setting/option_id
					[
						'mime_type' => 'image',
						'section' => 'allianz_frontpage_design',
						'label' => __('Hero image selection', 'twentytwenty'),
						'description' => __('High-resolution image for full screen', 'twentytwenty')
					]
				)
			);
