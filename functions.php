...
function twentytwenty_sidebar_registration() {
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Damen 1', 'twentytwenty' ),
				'id'          => 'frontpage-d1',
				'description' => __( 'All widgets here are attached to the D1 homepage container', 'twentytwenty' ),
			)
		)
	);
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Herren 1', 'twentytwenty' ),
				'id'          => 'frontpage-h1',
				'description' => __( 'All widgets here are attached to the H1 homepage container', 'twentytwenty' ),
			)
		)
	);
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Sponsoring', 'twentytwenty' ),
				'id'          => 'sponsors',
				'description' => __( 'This is for the sponsoring wall', 'twentytwenty' ),
			)
		)
	);
